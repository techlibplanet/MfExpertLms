...
class SyncSettingsFragment : Fragment() {
    ...
    private fun setSettingsItem() {
        modelList.clear()
        modelList.add(SyncViewModels("District", activity?.getPref(SP_DISTRICT_SYNC_TIME,"")!!, R.id.sync_switch))
        modelList.add(SyncViewModels("Relation",activity?.getPref(SP_RELATION_SYNC_TIME,"")!!, R.id.sync_switch))
        modelList.add(SyncViewModels("Occupation",activity?.getPref(SP_OCCUPATION_SYNC_TIME,"")!!, R.id.sync_switch))
        modelList.add(SyncViewModels("Literacy",activity?.getPref(SP_LITERACY_SYNC_TIME,"")!!, R.id.sync_switch))
