...
class ReligionSyncService : Service() {
    ...
    override fun onCreate() {
        ...
        val depComponent = DaggerInjectServiceComponent.builder()
                ...
                .build()
        depComponent.injectReligionSyncService(this)

        synchronized(syncAdapterLocker) {
            if (syncAdapter == null) {
//                syncAdapter = MastersSyncAdapter(applicationContext, true, false, roomDatabase, masterService)
                syncAdapter = ReligionSyncAdapter(applicationContext, true, false, database, mastersService)
                Log.d("Sync", "Religion sync adapter created.")
            }
        }
    }
    ...
    companion object {
        ...
        private var syncAdapter: ReligionSyncAdapter? = null
    }
}